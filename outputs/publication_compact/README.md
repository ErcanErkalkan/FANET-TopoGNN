...
The full directory is included in GitHub releases and Zenodo archives so the manuscript claim that the repository contains `outputs/publication_compact/` remains directly verifiable.

Archive note: The distributable archive excludes `.git/` and local repository metadata.
